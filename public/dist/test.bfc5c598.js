...
var bitcoin = new _blockchain.default();
var a = 0,
    b = 0;

for (; a < 20; a++) {
  bitcoin.createNewBlock(b + a, "a".concat(a + 2, "b").concat(a + 1), "a".concat(b + 1, "b").concat(a + 2));
}

bitcoin.createNewTransaction(100, '멍청이', 'ㅁㄴㅇㅁㄴㅇ');
console.log(bitcoin.chain[1]);
},{"./blockchain":"js/blockchain.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
